...
public class Blaze4D implements ModInitializer {
    public static final Logger LOGGER = LogManager.getLogger("Blaze4D Render System", new StringFormatterMessageFactory());
    ...
    public void onInitialize() {
        ...
        Aftermath.enableGPUCrashDumps(
                ...
                (pShaderDebugInfo, shaderDebugInfoSize, pUserData) -> {
                    LOGGER.error("Shader Debug Callback: %d, %d, %d", pShaderDebugInfo, shaderDebugInfoSize, pUserData);
                },
                (addValue, pUserData) -> {
                    LOGGER.info("GPU Crash Description Callback: %d, %d", addValue, pUserData);
                    Map<Integer, String> info = Map.of(0x00000001, "Blaze 4D",
                            0x00000002, "v1.0",
                            0x00010000, "This is a GPU crash dump example.",
                            0x00010000 + 1, "Engine State: Rendering.",
                            0x00010000 + 2, "More user-defined information..."
                    );
    ...
    private static void writeGpuCrashDumpToFile(long pGpuCrashDump, int gpuCrashDumpSize) {
