...
public class Blaze4DPreLaunch implements PreLaunchEntrypoint {
    ...
    public void onPreLaunch() {
        ...
        if (Platform.get().equals(Platform.WINDOWS) && JEmalloc.JEMALLOC_VERSION_MAJOR == 5 && JEmalloc.JEMALLOC_VERSION_MINOR >= 0 && JEmalloc.JEMALLOC_VERSION_MINOR <= 2 && JEmalloc.JEMALLOC_VERSION_BUGFIX < 1) {
