...
public record ConsumerCreationInfo(VertexFormat.DrawMode drawMode, VertexFormat format, Texture[] textures, ShaderProgram shader, Matrix4f projMatrix, Matrix4f viewMatrix, Vector3f chunkOffset, Vec3f shaderLightDirections0, Vec3f shaderLightDirections1) {
    ...
    public boolean equals(Object o) {
        ...
        return drawMode == that.drawMode && Objects.equals(format, that.format) && Arrays.equals(textures, that.textures) && shader == that.shader && Objects.equals(projMatrix, that.projMatrix) && Objects.equals(viewMatrix, that.viewMatrix) && Objects.equals(chunkOffset, that.chunkOffset) && Objects.equals(shaderLightDirections0, that.shaderLightDirections0) && Objects.equals(shaderLightDirections1, that.shaderLightDirections1);
    }
